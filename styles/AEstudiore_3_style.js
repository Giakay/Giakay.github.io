...
var style_AEstudiore_3 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(0,0,0,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 7}), fill: new ol.style.Fill({color: 'rgba(115,52,159,0.0)'}),
...
function update() {
    ...
    var features = lyr_AEstudiore_3.getSource().getFeatures();
