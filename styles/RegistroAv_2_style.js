...
var style_RegistroAv_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(0,0,0,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0}), fill: new ol.style.Fill({color: 'rgba(175,233,255,1.0)'}),
...
function update() {
    ...
    var features = lyr_RegistroAv_2.getSource().getFeatures();
